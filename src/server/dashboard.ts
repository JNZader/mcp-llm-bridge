  ...
  <div class="container">
    ...
    <section id="sec-files">
      ...
      <div class="card">
        ...
        <p class="help-text">Auth files are encrypted at rest. Recommended uploads: opencode -> auth.json, claude -> .credentials.json (or full .claude files), gemini -> settings.json + oauth_creds.json, qwen -> settings.json + oauth_creds.json, codex -> auth.json (or full .codex files).</p>
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
